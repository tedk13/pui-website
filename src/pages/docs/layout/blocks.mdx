...
skellyCSS: true
---
import Blockgrid from '../../../components/block-grid.astro'
...
<Blockgrid padding="blocks p-2" level="4">
...
<Blockgrid level="4" padding="blocks p-2" >
...
<Blockgrid level="4" padding="blocks p-2 tablet-up-3" >
  <div class="block">
    <div class="card">
      <code>block</code>
    </div>
...
<Blockgrid level="4" padding="tablet-up-2 blocks p-2" >
<div class="block">
  <div class="card">
    <code>block</code>
  </div>
...
<Blockgrid level="5" padding="blocks p-2" >
