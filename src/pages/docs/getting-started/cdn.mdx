...
Leaving out a version will always fetch the latest. Adding <PuiVersion/>, or whatever version you're looking for, after `platform-ui` will get that specific version. 
</Callout >
