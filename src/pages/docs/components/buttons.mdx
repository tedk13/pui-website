...
<div class="actions block">
  <ul class="list">
    <li>
      <button class="button" data-example-elements="button--navy">`.button--navy`</button>
    </li>
    <li>
    ...
    <li>
      <button class="button" data-example-elements="button--med-blue">`.button--med-blue`</button>
    </li>
    <li>
    ...
    <li>
      <button class="button" data-example-elements="button--salmon">`.button--salmon`</button>
    </li>
    <li>
      <button class="button" data-example-elements="button--brown">`.button--brown`</button>
    </li>
    <li>
      <button class="button" data-example-elements="button--orange">`.button--orange`</button>
    </li>
    <li>
