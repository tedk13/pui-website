...
<div class="info-box flex-inline">
  <button class="button toggle-hidden" role="button" aria-label="Toggle">Open Info Box</button>
  <div class="info-box__content">
    <button class="button info-box__close">Close <i class="pi-times"aria-hidden="hidden"></i></button>
